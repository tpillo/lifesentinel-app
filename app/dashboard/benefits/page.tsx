  ...
  return (
    <div className="min-h-screen bg-[#faf8f5]">
      ...
      <main className="mx-auto max-w-4xl px-6 py-8 md:px-8 space-y-6">
            ...
            {hasHardcodedState ? (
              ...
              <div className="rounded-2xl border border-amber-100 bg-amber-50/40 px-5 py-4">
                <p className="text-sm text-amber-800 leading-relaxed">
                  ...
                  analysis below. Look for the State Benefits section in the report.
                </p>
        ...
        {/* AI Streaming — Detailed Analysis */}
        <section>
          <div className="flex items-center gap-3 mb-4">
            <span className="text-amber-500 select-none">◈</span>
            <h2 className="font-serif text-xl font-semibold text-stone-900">Detailed Benefits Analysis</h2>
            {streamLoading && (
