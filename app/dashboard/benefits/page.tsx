      ...
      <main className="mx-auto max-w-6xl px-6 py-8 md:px-8 space-y-6">
        ...
        {!profileLoading && profile && (
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <DeadlineTimeline showVeteranContent={showVeteranContent} />
          </div>
        )}


        {/* VSO + Disclaimer — side by side on lg, VSO only for veteran-context users */}
        {!profileLoading && showVeteranContent && (
          <div className="grid gap-6 lg:grid-cols-2">
