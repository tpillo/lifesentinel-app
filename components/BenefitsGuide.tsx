    ...
    <div className="rounded-2xl border border-emerald-200 bg-emerald-50/40 p-6">
      ...
      <ul className="space-y-2 mb-3">
        {[
          ...
          "Eligibility: veteran rated 90%+ P&T, or service member killed/MIA/POW — veteran and dependent must have resided in Virginia for 5 years (not necessarily 60 months — call VMSDEP at 804-225-2083 to clarify your specific situation)",
